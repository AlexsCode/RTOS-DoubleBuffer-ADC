...
//Fixed Sizes;
enum {BUFFER_LEN = 10 }; //buffer size
enum {MESSAGE_LEN = 100}; // max message is 100 chars wide.
enum {MESSAGE_QUEUE_LEN = 5}; // MOST 5 messages in queue allowed.
enum {COMMAND_BUFFER_LEN = 255}; // number of characters in a command buffer.
